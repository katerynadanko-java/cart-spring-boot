...
//    public ResponseEntity<Cart> updateProductAmountInCart(@PathVariable Long cartId, @PathVariable Long productId, @PathVariable Integer amount) throws IOException {
...
//    public ResponseEntity<Cart> deleteProductFromCart(@PathVariable Long cartId, @PathVariable Long productId) throws IOException {
//        log.debug("Start to delete product with id ", productId);
//        return ResponseEntity.ok(cartService.deleteProductFromCart(cartId, productId));
//    }
//    @Transactional
//    @DeleteMapping("/{cartId}/delete/products")
//    public ResponseEntity<Cart> deleteProductFromCart(@PathVariable Long cartId) throws IOException {
